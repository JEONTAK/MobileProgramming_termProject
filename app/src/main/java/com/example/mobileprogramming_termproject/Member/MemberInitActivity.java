...
import com.example.mobileprogramming_termproject.login.FirstScreenActivity;
import com.example.mobileprogramming_termproject.login.RegisterActivity;
...
public class MemberInitActivity extends AppCompatActivity {
    ...
    private void profileUpdate() {
        ...
        if(name.length() > 0 && phoneNumber.length() > 9 && birthDay.length() > 5 && address.length() > 0){
            ...
            MemberInfo memberInfo = new MemberInfo(name,phoneNumber,address, birthDay,"https://e7.pngegg.com/pngimages/867/694/png-clipart-user-profile-default-computer-icons-network-video-recorder-avatar-cartoon-maker-blue-text.png",nickname,bookmarkRecipe,null);
            if(user != null){
