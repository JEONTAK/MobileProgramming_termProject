package com.example.mobileprogramming_termproject.Gallery;
...
public class GalleryAdapter extends RecyclerView.Adapter<com.example.mobileprogramming_termproject.Gallery.GalleryAdapter.GalleryViewHolder> {
    ...
    @Override
    public com.example.mobileprogramming_termproject.Gallery.GalleryAdapter.GalleryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
